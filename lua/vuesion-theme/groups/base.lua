...
function M.get(c, opts)
  ...
  local groups = {
    ...
    CurSearch = { fg = c.bg, bg = c.green_light },
    IncSearch = { fg = c.bg, bg = c.green_light },
    Search = { bg = c.bg_search, fg = c.bg },
    ...
    FlashLabel = { fg = c.blue, bold = true },
    FlashMatch = { fg = c.blue, bold = true },
